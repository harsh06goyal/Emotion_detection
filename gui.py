...
# download haarcascade_frontalface_default from here "https://github.com/opencv/tree/master/data/haarcascades"

def FacialExpressionModel(json_files, weights_file):
...
EMOTIONS_LIST = ["Angry","Disgust","Fear","happy","Neytral","Sad","Syrprise"]
